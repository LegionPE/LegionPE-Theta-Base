...
use legionpe\theta\command\admin\BanCommand;
use legionpe\theta\command\admin\PrivateNoticeCommand;
use legionpe\theta\command\admin\ServerTeleportPlayerCommand;
...
abstract class ThetaCommand extends Command implements PluginIdentifiableCommand{
	...
	public static function registerAll(BasePlugin $main, CommandMap $map){
		...
		$map->registerAll("l", [
			...
			new ServerTeleportPlayerCommand($main),
			...
			new TransferCommand($main, ["spleef", "spf", "splf"], "Spleef", Settings::CLASS_SPLEEF),
			...
			new TransferCommand($main, ["castlewars", "cw"], "Castle Wars", Settings::CLASS_CASTLE_WARS),
